        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Edited_on = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Position = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Salary = table.Column<int>(type: "int", nullable: true),
                    User_id = table.Column<int>(type: "int", nullable: false),
                    Nationality = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Marital_status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    National_number = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Iqama_number = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLateCheckIn = table.Column<bool>(type: "bit", nullable: false),
                    IsEarlyCheckOut = table.Column<bool>(type: "bit", nullable: false),
